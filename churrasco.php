...
$tsql= "SELECT id_produto,Nomeproduto,Descricao,preco from produto join Categoria on Produto.id_categoria=Categoria.id_categoria where nome='Churrasco'";
