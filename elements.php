			...
			<div id="main" class="container">
				<div class="card card text-white bg-dark mb-3">
				  ...
				  <div class="card card text-white bg-dark mb-3">
					...
					<div class="card-body">
					  <img src="images/depositphotos_41466555-stock-photo-image-of-slice-of-pizza.jpg" class="card-img-top">
					  <h2 class="card-title ">Pizzas</h2>
					  <p class="card-text ">With supporting text below as a natural lead-in to additional content.</p>
					  <a href="pizza.php" class="btn btn-outline-danger text-decoration-none" >Escolher</a>
					</div>
				  </div>
				  <hr />
				  <div class="card card text-white bg-dark mb-3">
					...
					<div class="card-body">
					  <img src="images/churrasco.jpg" class="card-img-top">
					  <h2 class="card-title ">Churrasco</h2>
					  <p class="card-text ">With supporting text below as a natural lead-in to additional content.</p>
					  <a href="churrasco.php" class="btn btn-outline-danger text-decoration-none">Escolher</a>
					</div>
				  </div>
		<!--Modal-->
<style>
