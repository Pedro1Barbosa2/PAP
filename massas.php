...
$tsql= "SELECT id_produto,Nomeproduto,Descricao,preco from produto join Categoria on Produto.id_categoria=Categoria.id_categoria where nome='Massas'";
	...
	<body class="subpage">
		...
		<!-- Nav -->
            ...
            <div id="main" class="container">
                <!-- Form -->
								<h3 style="text-align:center;">Massas</h3>
								<hr />
								<form method="post" action="addcart3.php">
